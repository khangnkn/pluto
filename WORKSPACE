...
go_repository(
    ...
    sum = "h1:KaMb5GLhlcSX+e+qhbRJODnUUBvlw01jt4yrjFIHAuA=",
    version = "v2.1.0",
)
...
go_repository(
    ...
    sum = "h1:AnRMUyVdVvh1k7lHe61YEd227+CLoNogQuAypztGSK4=",
    version = "v3.3.22+incompatible",
)
...
go_repository(
    ...
    sum = "h1:6HjxSjqdmgnujDPhlzR4a44lxK3w03WPN8te0SoUSeM=",
    version = "v1.56.0",
)
...
go_repository(
    name = "com_github_ltpquang_zbumper",
    importpath = "github.com/ltpquang/zbumper",
    sum = "h1:uiKWTJwkhR90JCp8ydRfCbleLDi/JykDkWZHQUiRyYM=",
    version = "v1.0.3",
)
...
go_repository(
    ...
    sum = "h1:xPECnNgZUaf6vpnmpR2Vt/SWE62B+Yvr/CBwsmTxgH4=",
    version = "v2.2.0",
)
...
go_repository(
    name = "com_github_t_tiger_gorm_bulk_insert_v2",
    importpath = "github.com/t-tiger/gorm-bulk-insert/v2",
    sum = "h1:HGVkRrwDCbmSP6h1CoBDj6l/mhnvsP5JbYaQ4ss0R6o=",
    version = "v2.0.1",
)
...
go_repository(
    ...
    sum = "h1:3M/uUZajYn/082wzUajekePxpUAZhMTfXvI9R+26SJ0=",
    version = "v0.0.0-20200121091418-667557018717",
)
...
go_repository(
    ...
    sum = "h1:DOmugCavvUtnUD114C1Wh+UgTgQZ4pMLzXxi1pSt+/Y=",
...
go_repository(
    ...
    sum = "h1:e7nYe9s94RHunFJ7b+mmPxiQMOKMVSqYASToWb1EcHs=",
    version = "v0.0.0-20200513154647-78b527d18275",
)

go_repository(
    name = "org_golang_x_tools_gopls",
    importpath = "golang.org/x/tools/gopls",
    sum = "h1:0e3BPxGV4B3cd0zdMuccwW72SgmHp92lAjOyxX/ScAw=",
    version = "v0.4.1",
)
...
go_repository(
    ...
    sum = "h1:WTxcE9VicMCGSB//JfMtpD9XP500wJx6w8lYEcsdPQk=",
    version = "v1.11.0",
)
